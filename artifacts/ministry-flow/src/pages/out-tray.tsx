...
import { Inbox as InboxIcon, Eye, CornerUpRight, Download, Search, Send } from "lucide-react";
...
export default function OutTray() {
  const { data: documents, isLoading } = useGetDocuments({ view: 'outbox' });
  ...
  return (
    <AppLayout title="">
      <div className="animate-in fade-in duration-500 space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Out-Tray</h1>
          <p className="text-slate-500 mt-1">Documents you have dispatched</p>
        </div>
        ...
        <Card className="border-slate-200 shadow-sm overflow-hidden bg-white">
          ...
          {isLoading ? (
            <div className="p-12 text-center text-slate-400">Loading out-tray...</div>
              ...
              <Table>
                <TableHeader className="bg-slate-50">
                  <TableRow>
                    ...
                    <TableHead className="font-semibold text-slate-600 text-xs uppercase tracking-wider">Date Sent</TableHead>
            ...
            <div className="p-16 text-center">
              ...
              <h3 className="text-lg font-medium text-slate-900">Your out-tray is empty</h3>
              <p className="text-slate-500 mt-1">You haven't dispatched any documents recently.</p>
            </div>
          )}
        </Card>
      </div>
